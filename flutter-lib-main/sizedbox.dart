...
class Wrapper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      // SizedBox.expand() is for expanding it to the highest (in its parent's context) and SizedBox.shrink() is for shrinking it to the lowest (in its parent's context)
      child: SizedBox(
          height: 50,
          width: 200,
